...
export default function () {
  ...
  const {
    ...
    error,
    refetch,
  } = useQuery("singleOrder", fetchProduct);
  const handleRefetch = () => {
    refetch();
  };
  ...
  const totalProfit = singleProduct.orders.reduce((accumulator, order) => {
    return accumulator + order.order_items.reduce((orderAccumulator, item) => {
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="stats-info">
                  ...
                  <h4>
                    {singleProduct.notifications.length}
                  </h4>
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="stats-info">
                  ...
                  <h4>
                    {formatDate(singleProduct.product.updated_at)}
                  </h4>
                </div>
              </div>
            </div>
                        ...
                        <table className="table table-striped custom-table mb-0 datatable">
                          ...
                          <tbody>
                            {singleProduct.notifications &&
                              singleProduct.notifications.map((notification) => (
                                <>
                                  <tr>
